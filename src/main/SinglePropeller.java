 ...
 */
public class SinglePropeller {

    private Propeller parent;
    ...
    public SinglePropeller ( Propeller parent, PVector centerPos, float startLength, boolean rotationDirection, int steps, int currentStep, float stepIncrease, float spikyness, int color, float lineThickness ) {
        this.parent = parent;
